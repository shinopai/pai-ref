    ...
    <div class="item w-2/3 h-auto">
                        ...
                        <div>
                            <div class="p-2 pl-0">
                                <div class="flex items-center p-2 pl-0 gap-2">
                                    ...
                                    <input type="text" name="keyword" placeholder="タイトルor説明文" class="border p-2 w-2/3 focus:outline-none text-gray-700" id="keyword" value="" />
                                </div>
                            </div>
                        </div>
                        <div class="flex justify-center"><button type="submit" class="p-2 border w-1/4 rounded-md bg-gray-800 text-white hover:underline">検索</button></div>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto mt-5 bg-white py-5 px-2">
            ...
            <a href="{{ route('photos.showAll') }}">
                <button class="text-blue-500 block w-full mt-3 py-1 rounded text-center border hover:bg-blue-100 hover:border-blue-400">全写真を見る<span class="material-icons" style="vertical-align: -6px;">
                        chevron_right
                    </span></button>
            </a>
        </div>
